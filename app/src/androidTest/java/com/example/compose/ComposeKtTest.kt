...
class ComposeKtTest {
    ...
    fun navHost_clickItem_navigatesToDetailWithData() {
        ...
        composeTestRule.onNodeWithText(CharacterData.konosubaCharacters[5].name).performClick()
        navController.assertCurrentRouteName(Screen.DetailCharacter.route)
        composeTestRule.onNodeWithText(CharacterData.konosubaCharacters[5].name).assertIsDisplayed()
    }
    ...
    @Test
    fun searchShowEmptyListCharacter() {
    ...
    @Test
    fun searchShowListCharacter() {
        val rightSearch = "zhaqian"
        composeTestRule.onNodeWithStringId(R.string.search_text).performTextInput(rightSearch)
        composeTestRule.onNodeWithText("zhaqian").assertIsDisplayed()
    }
    ...
    fun favoriteClickInDetailScreen_ShowInFavoriteScreen() {
        composeTestRule.onNodeWithText(CharacterData.konosubaCharacters[0].name).performClick()
        navController.assertCurrentRouteName(Screen.DetailCharacter.route)
        ...
        composeTestRule.onNodeWithStringId(R.string.menu_favorite).performClick()
        navController.assertCurrentRouteName(Screen.Favorite.route)
        composeTestRule.onNodeWithText(CharacterData.konosubaCharacters[0].name).assertIsDisplayed()
    }
